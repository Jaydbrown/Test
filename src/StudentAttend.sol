...
contract StudentAttendance {
    ...
    function welcome_to_class(string memory _name, uint8 _age) public {
    ...
    function take_attendance(uint256 _studentId, bool _present) public {
    ...
    function check_class_size() public view returns (uint256) {
        return students.length;
    }

    function get_student_info(uint256 _studentId) public view returns (string memory name, uint8 age, bool present) {
        require(_studentId < students.length, "Student does not exist");
